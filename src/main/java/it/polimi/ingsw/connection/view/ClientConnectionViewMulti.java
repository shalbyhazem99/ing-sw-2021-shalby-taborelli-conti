...
public class ClientConnectionViewMulti extends ClientConnectionView {
    ...
    public ClientConnectionViewMulti(String ip, int port) throws IOException {
            ...
            try {
                while (isActive()) {
                    ...
                    if (inputObject instanceof SendModel) {
                        ClientConnectionViewMulti.this.notify((SendModel) inputObject);
                    }
                    else if(inputObject instanceof EndMatchResponse) {
                        setActive(false);
                        ClientConnectionViewMulti.this.disconnect();
                        ClientConnectionViewMulti.this.notify((MoveResponse) inputObject);
                    }
