...
public class PositioningResourcesResponse extends MoveResponse {
    /**
     * Class used to represent the response of the system when the {@link it.polimi.ingsw.model.Player} asks to position his {@link Resource}
     */
    ...
    /**
     * Default constructor
     * @param numberOfDiscardedResources how many {@link Resource} got discarded
     * @param numberOfGainedResources how many {@link Resource} got gained
     */
    ...
    public void elaborateGUI(GenericController controller) {
        controller.manageResourceMarketPositioning(whereToPlace,getExecutePlayerPos());
    }
