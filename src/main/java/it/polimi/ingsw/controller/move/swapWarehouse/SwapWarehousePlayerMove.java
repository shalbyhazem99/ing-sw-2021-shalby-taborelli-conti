...
public class SwapWarehousePlayerMove extends PlayerMove {
     ...
     */
    public SwapWarehousePlayerMove(int firstWarehouseIndex, int secondWarehouseIndex, int numberOfResources) {
        this.firstWarehouseIndex = firstWarehouseIndex;
        this.secondWarehouseIndex = secondWarehouseIndex;
        this.numberOfResources = numberOfResources;
    }

    public static SwapWarehousePlayerMove getInstance(int firstWarehouseIndex, int secondWarehouseIndex, int numberOfResources) {
        return new SwapWarehousePlayerMove(firstWarehouseIndex, secondWarehouseIndex, numberOfResources);
    }

    @Override
    public void execute(Match match){
        match.MoveResourcesInteraction(firstWarehouseIndex,secondWarehouseIndex,numberOfResources,getPlayer());
